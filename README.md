...
# ubuntu-iso-builder-prev-respin-xfce
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-prev-respin-xfce/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-prev-respin-xfce/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-prev-respin-xfce/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-prev-respin-xfce](https://github.com/samwhelp/ubuntu-iso-builder-prev-respin-xfce)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-prev-respin-xfce.git
```


> change dir to `ubuntu-iso-builder-prev-respin-xfce`

``` sh
cd ubuntu-iso-builder-prev-respin-xfce
```
...
| [ubuntu-iso-builder-remix-xfce](https://github.com/samwhelp/ubuntu-iso-builder-remix-xfce) | [ubuntu-iso-builder-prev-respin-xfce](https://github.com/samwhelp/ubuntu-iso-builder-prev-respin-xfce) |
